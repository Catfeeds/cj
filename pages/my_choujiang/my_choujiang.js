// pages/my_choujiang/my_choujiang.js
...
Page({
    ...
    onPullDownRefresh: function () {
        ...
        this.getMyCanyuChoujiang('pulldown');
    },
    ...
    onReachBottom: function () {
        this.getMyCanyuChoujiang();
    },
    navbarTap: function (e) {
        this.setData({
            currentTab: e.currentTarget.dataset.idx,
            huodong_state: e.currentTarget.dataset.idx
        })
        this.setData({
            page: 1,
            hasNext: true,
    ...
    getMyCanyuChoujiang:function(mytype){
        if (this.data.hasNext){
            ...
            var _this = this;
            wx.request({
                url: app.globalData.server_url + 'xcx/user/get_my_canyu_choujiang',
                method: 'POST',
                data: {
                    'openid': openid,
                    'sendtime': sendtime,
                    ...
                    'huodong_state': _this.data.huodong_state
                },
                success(data) {
